...
- **go-reviewer**: Reviews Go code examples for idiomatic patterns
- **frontend-reviewer**: Reviews Next.js/React code for frontend best practices
- **supabase-reviewer**: Reviews Supabase/Postgres code for security and performance
