...
**If PR contains Go files (*.go):**

16. Task go-reviewer(PR content) - Reviews Go code for idiomatic patterns, production reliability, and strict conventions

**If PR contains Next.js/React files (*.tsx, *.jsx, next.config.*):**

17. Task frontend-reviewer(PR content) - Reviews frontend code for type safety, React hooks, and Server Component patterns

**If PR contains Supabase files (supabase/migrations/*, supabase/functions/*, or .sql files with RLS/policies):**

18. Task supabase-reviewer(PR content) - Reviews Supabase/Postgres code for RLS policies, migration safety, and performance
