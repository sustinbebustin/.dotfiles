...
Present the reports under `## Standards`, `## Spec`, and `## Comments` headings, verbatim or lightly cleaned. Do **not** merge or rerank findings — the axes are deliberately separate (see _Why separate axes_).
