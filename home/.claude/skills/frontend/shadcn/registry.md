...
- **Built registry**: generated JSON files served to CLI consumers, usually
  from `public/r`. Use `pnpm dlx shadcn@latest build` to create this form.
...
pnpm dlx shadcn@latest build registry.json --output public/r
```
...
pnpm dlx shadcn@latest search @acme -q "login"
pnpm dlx shadcn@latest view @acme/login-form
pnpm dlx shadcn@latest add @acme/login-form --dry-run
