---
description: Multi-repository codebase expert for library internals and remote code analysis. Invoke for GitHub/npm/PyPI/crates exploration, implementation tracing, cross-repo comparisons, and current docs/discussion research.
mode: subagent
options:
  thinking:
    type: enabled
