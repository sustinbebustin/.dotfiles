...
See [changelog-format.md](references/changelog-format.md) for the detailed format specification.
See [changelog-template.md](examples/changelog-template.md) for a ready-to-use template.