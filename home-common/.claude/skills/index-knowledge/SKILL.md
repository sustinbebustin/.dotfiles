...
Use /index-knowledge when:

- Creating or refreshing CLAUDE.md knowledge bases for a codebase
- Onboarding new contributors who need a navigable map
- After large refactors that change module boundaries or conventions
- You want a structured, hierarchical overview of the project
...
find . -type f \( -name "CLAUDE.md" -o -name "CLAUDE.md" \) -not -path '*/node_modules/*' 2>/dev/null
```
