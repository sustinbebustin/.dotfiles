---
name: shadcn
description: shadcn/ui workflows — adding, composing, styling, and debugging components, plus project init, presets, and registries.
...
9. **Switching presets** — Ask the user first: **reinstall**, **merge**, or **skip**?
   - **Reinstall**: `npx shadcn@latest init --preset <code> --force --reinstall`. Overwrites all components — use when the user hasn't customized them.
